...
display_usage() {
    ...
    echo "Input files:"
    echo "   The first input is Count_file.csv, check AP-5782–11–08–2018_COUNTS.csv  as an example format"
    echo "   The second input is Sample_info.csv, check AP-5782–11–08–2018_sample_info.csv as an example format"
    echo "   The third input is Conparisons.csv, check AP-5782–11–08–2018_comparisons.csv as an example format"
...
/usr/bin/Rscript /home/genomics/genomics/data/Temp/Di_RNA_seq_test/AY-6348--02--05--2019_test/RNAseq_tier2.R $1 $2 $3 $4
