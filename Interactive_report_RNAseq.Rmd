...
p<-p+theme(panel.background = element_rect(fill = "white", colour = "black"))+geom_label_repel(point.padding = unit(0.1, "lines"))+labs(x = paste0("log2FoldChange (", name, ")"), y = "-log10(adjusted p-value)", title = "M -> MC", color = "")
p
dev.off()
```
